...
class MyBookingsDetails extends React.Component {
  ...
  //  if (driver==0){
  //   this.setState({timing:'With Driver'})
  //  }
  //  else{
  //   this.setState({timing:'Without Driver'})
  //  }
  ...
  // }
    handlReport=async()=>{
      ...
      const response = await fetch('http://192.168.1.153:5000/api/owner/reportCustomer/'+customerId, {
          method: 'POST',
          headers: {
  ...
  //  const year =this.props.route.params.item.customerFeedback.rating;
   // const fare =this.props.route.params.item.customerFeedback.feedback;
   ...
   <Text size={14} color="#8898AA" style={{ marginTop: 10, marginLeft:10 }}>
    ...
    >
          ...
          <Text  style={{ fontSize: 20}} bold color={argonTheme.COLORS.BLACK}>
                    Customer Feedback
                  </Text>
        <Block style={styles.divider} />
