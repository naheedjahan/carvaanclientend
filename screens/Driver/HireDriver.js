  ...
  return (
    ...
    >
      ...
      <View style={{ alignItems: 'center', flex: 1, marginLeft: 20 }}>
        ...
        />
        <Text style={{ color: 'green', marginTop: 7 }}>{item.address}</Text>
      </View>
...
class HireDriver extends React.Component {
  constructor(props) {
    super(props);
  ...
  getData = async () => {
    ...
    const response = await fetch(baseUrl + 'api/Customer/viewDriver', {
      method: 'GET',
      headers: {
        'x-auth-token': token,
      },
